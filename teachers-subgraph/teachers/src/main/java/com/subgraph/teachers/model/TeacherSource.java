...
public final class TeacherSource {
  ...
  private static final Map<Long, List<Teacher>> teacherMap = Map.of(
    2L, List.of(new Teacher("1020", "Very cramped :( Do not recommend.", 2), new Teacher("1021", "Got me to the Moon!", 4)),
    3L, List.of(new Teacher("1030", 3)),
    4L, List.of(new Teacher("1040", 5), new Teacher("1041", "Reusable!", 5), new Teacher("1042", 5)),
    5L, List.of(new Teacher("1050", "Amazing! Would Fly Again!", 5), new Teacher("1051", 5))
  );
